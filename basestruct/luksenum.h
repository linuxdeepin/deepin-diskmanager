...
enum CRYPTError {
    ...
    CRYPT_ERR_DEVICE_NO_EXISTS,
    CRYPT_ERR_DM_DEVICE_NO_EXISTS,
    CRYPT_ERR_MOUNT_FAILED,
    CRYPT_ERR_ADD_KEY_FAILED,
    CRYPT_ERR_DEL_KEY_FAILED,
    CRYPT_ERR_CRYPTTAB_FAILED
};

...
signals:
     ...
     * @param 要同步的硬件信息
     */
    void updateDeviceInfo(/*const QMap<QString, Device> m_deviceMap, */const DeviceInfoMap infomap, const LVMInfo lvmInfo,const LUKSInfoMap&luks);
...
private:
    ...
    LUKSInfoMap m_luksInfo;            //luks 属性信息
};
